"""Autopark — рендер Markdown в HTML для собственного хаба документации.
...
после переноса на ядро модулей общий код о модуле вообще не знает). Поэтому
...
def docs_md_to_html(markdown_content: str) -> str:
    """Конвертация Markdown в HTML для docs viewer модуля Autopark."""
    try:
        import markdown
