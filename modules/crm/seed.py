...
ITEMS = [
    ...
    ("T-003", "Труба ПВХ 50 мм", "Товар", "м", 95, 320), ("T-004", "Кабель ВВГ 3×2.5", "Товар", "м", 38, 900),
    ...
    ("P-004", "Стол офисный СО-120", "Изделие", "шт", 3200, 3), ("P-005", "Ворота металлические 3×2", "Изделие", "компл", 15800, 0),
]
...
PROJECTS = [
    ("Панно с логотипом на стену 3×1,5 м (акрил, подсветка)", 11, "Реклама", "Производство", "T-2026-014", 48000, 50, -20, 10, "Ion Popescu", "Тендер IT-Solutions: панно в холле офиса. Производство — партнёр BM PUBLIC."),
    ...
    ("Световой короб на фасад магазина 4×1 м", 12, "Реклама", "Проигран", "T-2026-009", 61000, 40, -30, 5, "Ion Popescu", "Тендер проигран по цене — заявка сохранена для следующего раза."),
    ...
    ("Выставочный стенд Moldexpo 6×3 м с панно и подсветкой", 10, "Монтаж", "Производство", "T-2026-019", 96000, 50, -25, -3, "Victor Botnari", "Запаздывает: срок сдачи прошёл, конструкция ещё в производстве. Монтаж — BM PUBLIC."),
