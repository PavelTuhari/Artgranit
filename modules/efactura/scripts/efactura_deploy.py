#!/usr/bin/env python3
"""Instalatorul DDL al modulului e-Factura (conturul EFA_*).
...
Rulare (din radacina proiectului, pe orice contur cu .env valid):
    python3 modules/efactura/scripts/efactura_deploy.py
"""
import os
import sys
...
def main():
    ...
    r = db.execute_query(
        ...
        "WHERE OBJECT_NAME LIKE 'EFA%' ORDER BY OBJECT_TYPE, OBJECT_NAME")
    print("== obiecte EFA_* in USER_OBJECTS ==")
