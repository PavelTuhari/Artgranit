#!/usr/bin/env python3
"""Instalatorul DDL al modulului Partner API (conturul PAPI_*).
...
Rulare (din radacina proiectului, pe orice contur cu .env valid):
    python3 modules/partner/scripts/partner_deploy.py
"""
import os
import sys
...
SQL_DIR = os.path.join(ROOT, "modules", "partner", "sql")
...
def main():
    ...
    r = db.execute_query(
        ...
        "WHERE OBJECT_NAME LIKE 'PAPI%' ORDER BY OBJECT_TYPE, OBJECT_NAME")
    print("== obiecte PAPI_* in USER_OBJECTS ==")
