#!/usr/bin/env python3
"""Instalatorul DDL al puntii Contragenti (conturul CTG_*).
...
Rulare (din radacina proiectului, pe orice contur cu .env valid):
    python3 modules/contragenti/scripts/contragenti_deploy.py
"""
import os
import sys
...
SQL_DIR = os.path.join(ROOT, "modules", "contragenti", "sql")
...
def main():
    ...
    r = db.execute_query(
        ...
        "WHERE OBJECT_NAME LIKE 'CTG^_%' ESCAPE '^' ORDER BY OBJECT_TYPE, OBJECT_NAME")
    print("== obiecte CTG_* in USER_OBJECTS ==")
