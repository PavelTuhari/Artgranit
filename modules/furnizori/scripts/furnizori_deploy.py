#!/usr/bin/env python3
"""Установщик DDL модуля furnizori — СВОЙ, общий deploy_oracle_objects.py не трогаем.

    python modules/furnizori/scripts/furnizori_deploy.py            # установить
    python modules/furnizori/scripts/furnizori_deploy.py --dry-run  # только разбор
