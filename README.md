...
9.  **Планограммы (Planograms):** управление выкладкой товара и торговым пространством магазина — трёхъязычный модуль (**RU / RO / EN**).
    ...
    *   DDL: `sql/80..83_plg_*.sql` (модуль), `84..86` (генератор и прогноз), `87..90` (логистика, партнёры, представления, словарь); ставится отдельно: `python deploy_oracle_objects.py --only plg_`.
    *   Документация: `docs/Planograms/PLANOGRAMS_MODULE.md` (техническое описание), `docs/Planograms/INSTALL.md` (установка и скрипты развёртывания), `docs/Planograms/USER_GUIDE.md` (руководство пользователя), `docs/Planograms/PRESENTATION_PLAN.md` + `docs/Planograms/presentation.html` (презентация модуля).
