...
9.  **Планограммы (Planograms):** управление выкладкой товара и торговым пространством магазина — трёхъязычный модуль (**RU / RO / EN**).
    ...
    *   DDL: `sql/80..83_plg_*.sql` (модуль), `84..86` (генератор и прогноз), `87..90` (логистика, партнёры, представления, словарь), `91..92` (бизнес-процессы), `93` (фреш), `94` (мобильный контур), `95` (словарь новых разделов); ставится отдельно: `python deploy_oracle_objects.py --only plg_`.
