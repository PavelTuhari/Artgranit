...
9.  **Планограммы (Planograms):** управление выкладкой товара и торговым пространством магазина — трёхъязычный модуль (**RU / RO / EN**).
    ...
    *   DDL: `sql/80..83_plg_*.sql` (модуль), `84_plg_testdata.sql`, `85_plg_forecast.sql`, `86_plg_i18n_gen.sql` (генератор и прогноз); ставится отдельно: `python deploy_oracle_objects.py --only plg_`.
